...
class _SignUpPageState extends State<SignUpPage> {
  ...
  Future<void> _signUp() async {
    if (_signUpFormKey.currentState!.validate()) {
      ...
      final url = Uri.parse('http://localhost:4000/api/v1/auth/signup'); // Update URL with your backend URL
      ...
      if (response.statusCode == 200) {
        // Signup successful, navigate to account details page
  ...
  void navigateToAccountDetailsPage() {
    if (selectedAccountType == 'Farmer') {
      Navigator.of(context).push(MaterialPageRoute(
          builder: (context) => FarmerAccountDetailsPage()));
    } else if (selectedAccountType == 'Nursery') {
      Navigator.of(context).push(MaterialPageRoute(
          builder: (context) => NurseryAccountDetailsPage()));
    } else if (selectedAccountType == 'Storage') {
      Navigator.of(context).push(MaterialPageRoute(
          builder: (context) => StorageAccountDetailsPage()));
    }
  }
}
